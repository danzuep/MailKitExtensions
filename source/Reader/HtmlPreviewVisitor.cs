...
namespace MailKitExtensions.Reader
{
    ...
    /// http://www.mimekit.org/docs/html/M_MimeKit_MimeVisitor_VisitMessagePart.htm
    /// </summary>
    internal class HtmlPreviewVisitor : MimeVisitor
    {
        IList<MultipartRelated> stack = new List<MultipartRelated>();
        IList<MimeEntity> attachments = new List<MimeEntity>();
        ...
        protected override void VisitTnefPart(TnefPart entity)
        {
            ...
            if (entity is not null)
                foreach (var item in entity.ExtractAttachments())
                    if (item is not null)
